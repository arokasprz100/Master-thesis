...
\thispagestyle{empty}
%% ------------------------ NAGLOWEK STRONY ---------------------------------
\includegraphics[height=37.5mm]{res/agh_nzw_a_pl_1w_wbr_cmyk}\\
\rule{30mm}{0pt}
...
\vspace{1.5ex}
{\sf\small specjalność:} {\bf\small \textsf{tylko na IS i FM}}\\
\vspace{10ex}
%% ------------------------ TYTUL PRACY --------------------------------------
...
Jana Nowaka,
studenta drugiego roku studiów drugiego stopnia na kierunku fizyka techniczna, specjalności jeśli występuje}\\
\end{center}
