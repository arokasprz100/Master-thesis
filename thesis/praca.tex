...
\newpage
\rightline{Kraków, wrzesień 2021}
\begin{center}
...
\includepdf[pages=1, scale=0.9,offset= 0.65cm -1.2cm, pagecommand={}]{static/recenzja_opiekun.pdf}

\clearpage\mbox{}\clearpage

%Recenzja nr 2
\includepdfset{pages=-,pagecommand=\thispagestyle{fancy}}
\includepdf[pages=1, scale=0.9,offset= 0.65cm -1.2cm, pagecommand={}]{static/recenzja_recenzent.pdf}
...
\include{2_technologies/technologies}
\include{3_ggss_introduction/ggss}
\include{4_infrastructure/infrastructure}
\include{5_code/code}
\include{6_tests/tests}
\include{7_summary/summary}
\include{8_extras/extras}
